...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 59.6px;">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="our_team.php">Our Team</a> 
    </div>
  </div>
</div>
...
<div class="row bottom40">
      <div class="col-md-12">
        <div class="term-condition bg_light">
          <h4 style="text-align:justify;padding-top: 0px;"><i style="color: #ed2a28;" aria-hidden="true" class="fa fa-square"></i>   Experienced Registered  enrolled bar council of India advocates across pan india.</h4>	 
		  </div>
<a href="advocate-registration.php" class="btn_fill" style="transition: none 0s ease 0s; line-height: 21px; border-width: 0px; padding: 12px 40px; letter-spacing: 0px; font-weight: 400; font-size: 15px;width:100%;margin-top:30px">    Advocate Registration</a>		  
     ...
     <!---- <div class="row mb-20">
        ...
        <div class="col-xs-12 col-sm-10 col-md-8 text-center">
          <h2 class="text-uppercase">Our Team <span class="color_red">Members </span></h2>
