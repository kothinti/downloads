...
<section class="rev_slider_wrapper">
  <div id="rev_slider_3" class="rev_slider"  data-version="5.0">
    <ul>
      ...
      <!-- SLIDE 2 -->
      <li data-transition="fade">
        <img src="images/banner-9.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" class="rev-slidebg">
        <div class="tp-caption tp-resizeme"               
          data-x="['left','left','left','left']" data-hoffset="['15','15','30','15']" 
          data-y="['240','200','140','140']" data-voffset="['0','0','0','0']"
          data-responsive_offset="on"
      ...
      <li data-transition="fade">
        ...
        <div class="tp-caption tp-resizeme"               
		  ...
		  <div style="border-left:5px solid #ed2a28;margin-top:50px;padding-left:10px;">
          <h2 style="color:#ed2a28;font-size:32px;">OUR STRENGTH</h2>
		  <h1 style="color:#fff;font-size:36px;"> 30+ years of <br/>senior <br/>Advocates</h1>	
		  </div>
        </div>
      </li>
      <!-- SLIDE 4 -->
    ...
    <div class="row">
      ...
      <div class="col-md-7 col-sm-7 col-xs-12">
        ...
        <div class="about-sev-tag">
          <p style="text-align:justify;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <b>Andhra Legal House &#38; Co.,</b> is a full-service Law Firm and one stop solution for all your legal needs. 
...
Family law, Trademark Registration, Copyrights and Immigration services.</p>          <ul>
          ...
          <div class="founder-text">
              ...
              <h3 style="font-weight:600;">Chitturi Srinivasa Rao, Founder.</h3>
...
<section id="estimate" class="padding parallaxie" style="background-image: url(images/estimate_bg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 4.05333px;">
  ...
  <div class="col-md-12 wow fadeIn text-center animated" style="visibility: visible; animation-name: fadeIn;">
      <h2 style="color:#fff;" class="text-uppercase">Need a<span class="color_red"> Legal Advice</span></h2>
      <div class="text-center seprator">
        <div class="line_4"></div>
        <div class="line_5"></div>
        <div class="line_6"></div>
...
<textarea style="background: #0000;border: 1px solid #fff;" name="EDYourMessage" id="EDYourMessage" placeholder="Write here something...." required></textarea>
 </div>
 </div>
...
<input class="btn_fill" name="Reset" value="Reset" type="reset">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
           <a href="advocate-registration.php" class="btn_fill" style="transition: none 0s ease 0s; line-height: 21px; border-width: 0px; padding: 12px 40px; letter-spacing: 0px; font-weight: 400; font-size: 15px;width:100%;margin-top:30px">    Advocate Registration</a>
        </div>        
		<div class="col-md-6 col-sm-12 col-xs-12">
           <a href="client-registration.php" class="btn_fill" style="transition: none 0s ease 0s; line-height: 21px; border-width: 0px; padding: 12px 40px; letter-spacing: 0px; font-weight: 400; font-size: 15px;width:100%;margin-top:30px;">   Client Registration</a>
        </div>			
       </div>		
     </div>
	 	 <div class="col-md-2 col-sm-6 col-xs-12"></div>
...
<!-- PARTNER -->
<!--=====#/ contact =====--> 
<section id="image-text" class="padding-bottom-top-30 parallaxie" style="background-image: url(images/bg-text.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 13.98px;">
  <div class="container" id="contact">
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="image-text-heading top30 bottom30 kgr">
          <h1 style="color:#fff;">Contact Us</h1>
		  <h4 style="color:#fff;font-size:17px;">The firm has always strived to create and implement innovative and effective methods of providing Quality representation and services for our clients. </h4>
...
<div class="get-tuch">
          <i class="icon-icons74"></i>
          <ul>
            <li><h2 style="color:#fff;">Andhra Legal House</h2></li>
            <li><h4>Visakhapatnam, Amaravathi, Hyderabad</h4></li>
            <li><h4>Bangalore, Chennai, Kerala,</h4></li>
            <li><h4>Pune, Mumbai.</h4></li>
          </ul>
        </div>		
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch">
          <i class="icon-icons74"></i>
          <ul>
            <li><h4>Andhra Legal House</h4></li>
            <li><p>Visakhapatnam, Amaravathi, Hyderabad</p></li>
            <li><p>Bangalore, Chennai, Kerala,</p></li>
            <li><p>Pune, Mumbai.</p></li>
          </ul>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
