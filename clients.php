...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 59.6px;">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="clients.php">Clients</a> 
    </div>
  </div>
</div>
  ...
  <div class="container">
    <div id="projects" class="cbp">
      <div class="cbp-item latest rent">
        <div class="image">
           <img src="images/apgovt.png" alt="">
           <div class="overlay">
              <a href="images/apgovt.png" class="fancybox centered" data-fancybox-group="gallery">
      ...
      <div class="cbp-item sale">
        <div class="image">
           ...
           <div class="overlay">
              <a href="images/hdfc.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item sale">
        <div class="image">
           <img src="images/citybank.png" alt="">
           <div class="overlay">
              <a href="images/citybank.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item latest rent">
        <div class="image">
        <img src="images/ongc.png" alt="">
           <div class="overlay">
              <a href="images/ongc.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item sale">
        <div class="image">
        <img src="images/SITICABLE.png" alt="">
           <div class="overlay">
              <a href="images/SITICABLE.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item latest rent">
        <div class="image">
           ...
           <div class="overlay">
              <a href="images/sbi.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item management sale">
        <div class="image">
        <img src="images/southindianbank.png" alt="">
           <div class="overlay">
              <a href="images/southindianbank.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item services sale latest">
        <div class="image">
        <img src="images/hpcl.png" alt="">
           <div class="overlay">
              <a href="images/hpcl.png" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
