...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 59.6px;">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="client-registration.php">Client Registration Form</a> 
    </div>
  </div>
</div>
 ...
 <div class="inner-column agent-p-form top40">
    <div class="row">
      <div class="col-md-12 bottom40">
        <h2 class="text-uppercase">Client<span class="color_red"> Registration</span></h2>
...
function validateformenq()
{
 ...
 return false;
  ...
  else if (document.formenq.EDCasenumber.value=="")
 {
 alert("Please Enter value for Case number");
 document.formenq.EDCasenumber.focus();
 return false;
 }
 ...
 {
 document.formenq.action="client-registration-FormProcess.php"
 document.formenq.submit()
 }
}
</script>

 <form action="client-registration-FormProcess.php" method="post" name="formenq" enctype="multipart/form-data" onsubmit=" return validateformenq();" required="">
...
<input name="EDContactPerson" id="EDContactPerson" size="30" class="keyword-input" placeholder="Your Name" type="text" required="">
  ...
  <div class="col-md-12 clearfix">
 <div class="single-query">
 <label style="color: #333;">Case number if any </label>
<input name="EDCasenumber" id="EDCasenumber" placeholder="Case number if any" class="keyword-input" type="text">
 </div>
 </div>
 <div class="col-md-12 clearfix">
 <div class="single-query">
...
<textarea name="EDYourMessage" id="EDYourMessage" placeholder="Write here something...." required=""></textarea>
 ...
 <div class="col-md-12 clearfix">				
 <div class="single-query">
 <label style="color: #333;">Documents Upload (.doc/.docx/.pdf) * </label>
