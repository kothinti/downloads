        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
          ...
          <div class="get-tuch text-left top20">
            ...
            <ul>
              ...
              <li>
                <p><a href="mailto:info@andhralegalhouse.org">info@andhralegalhouse.org</a></p>
              </li>
            </ul>
          </div>
        </div>
...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 59.6px;">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="advocate-registration-FormDone.php">Advocate Registration Form</a> 
    </div>
  </div>
</div>
...
<section class="contact-section-three">
        <div class="auto-container" style="padding-bottom:40px;">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch">
          ...
          <ul>
            ...
            <li><a href="mailto:info@andhralegalhouse.org">info@andhralegalhouse.org</a> </li>
          </ul>
        </div>
      </div>
    </div>
