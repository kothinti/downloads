...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 59.6px;">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="corporate.php">Corporate Social Responsibility</a> 
    </div>
  </div>
</div>
...
<!-----    <div class="row">
      <div class="col-md-12 bottom40">
        <h2 class="text-uppercase">Corporate <span class="color_red">Social Responsibility</span></h2>
    ...
    <div class="row bottom40">
      <div class="col-md-12">
        <div class="term-condition bg_light">
          <h4 style="text-align:justify;padding-top: 0px;"><i style="color: #ed2a28;" aria-hidden="true" class="fa fa-square"></i>   Protecting RTI, Human Rights, Child Rights and Women Rights.</h4>	 
		  </div><br/>
        <div class="term-condition bg_light">
          <h4 style="text-align:justify;padding-top: 0px;"><i style="color: #ed2a28;" aria-hidden="true" class="fa fa-square"></i>   Spreading awareness to Youth and common people about importance of education, skill development and legal issues.</h4>	   
		  </div>	<br/>	  
        <div class="term-condition bg_light">
          <h4 style="text-align:justify;padding-top: 0px;"><i style="color: #ed2a28;" aria-hidden="true" class="fa fa-square"></i>   To protect environment by Removal of Plastic Usage in Daily Human Life: Avoid Plastic every where.</h4>	   
		  </div>
      </div>
    </div>
