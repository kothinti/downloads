...
if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  {
		header('Location: resume.php?err=fail');
} else {
?>
<?
///////////////////////////////
...
?>
<?
$email_subject ="Job Application from www.andhralegalhouse.org";
$email_subjectMem ="Acknowledgement from www.andhralegalhouse.org";

$msgmem='<span style="font:11px arial;color:#333333;">Dear <span style="font:bold 12px arial;color:#F54E41;">'.$EDContactPerson.',</span><br><br>Thank you for posting your resume with <strong>www.andhralegalhouse.org</strong><br><br><strong><u>Resume Details :</u></strong><br>
Name: '.$EDContactPerson.'<br>Address: '.$EDAddress.'<br>Contact No: '.$EDContactNo.'<br>E-Mail ID: '.$EDEMailID.'<br>Subject: '.$EDTypeofBusiness.'<br><br><strong><u>Comments:</u></strong><br>'.$EDYourMessage.'<br><br>
<strong><u>Uploaded RESUME:</u></strong> <a href=https://andhralegalhouse.org/andhralegalhouse/resumes/'.$imagename.'>Download</a> <br><br>
...
<?
	...
	header('Location: Job-Application-FormDone.php?sts=success&NName='.$EDContactPerson);
