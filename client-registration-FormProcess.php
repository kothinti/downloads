...
$EDCasenumber=$_POST['EDCasenumber'];
...
if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  {
		header('Location: client-registration.php?err=fail');
} else {
?>
<?
///////////////////////////////
...
?>
<?
$email_subject ="Client Registration Form from www.andhralegalhouse.org";
$email_subjectMem ="Acknowledgement from www.andhralegalhouse.org";

$msgmem='<span style="font:11px arial;color:#333333;">Dear <span style="font:bold 12px arial;color:#F54E41;">'.$EDContactPerson.',</span><br><br>Thank you for posting your Client Registration with <strong>www.andhralegalhouse.org</strong><br><br><strong><u>Client Registration Details :</u></strong><br>
Name: '.$EDContactPerson.'<br>Case Number: '.$EDCasenumber.'<br>Address: '.$EDAddress.'<br>Contact No: '.$EDContactNo.'<br>E-Mail ID: '.$EDEMailID.'<br>Subject: '.$EDTypeofBusiness.'<br><br><strong><u>Comments:</u></strong><br>'.$EDYourMessage.'<br><br>
...
<?
	...
	header('Location: client-registration-FormDone.php?sts=success&NName='.$EDContactPerson);
